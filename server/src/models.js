...
const MessageSchema = new Schema({ ownerId: Schema.Types.ObjectId, projectId: Schema.Types.ObjectId, conversationId: Schema.Types.ObjectId, role: String, text: String, citations: Array, provider: String, fallbackUsed: Boolean, basis: String, createdAt: { type: Date, default: Date.now } });
